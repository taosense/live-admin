...
public class DateUtil {
	...
	public static String getCurrent() {
		...
		sb.append(year).append("_").append(StringUtil.addzero(month, 2)).append("_")
				.append(StringUtil.addzero(day, 2)).append("_")
				.append(StringUtil.addzero(hour, 2)).append("_")
				.append(StringUtil.addzero(minute, 2)).append("_")
				.append(StringUtil.addzero(second, 2));
		return sb.toString();
	}
...
//		logger.info("获取本季度第一天:" + du.getThisSeasonTime(DateUtil.getToMonth()).split(";"));
...
//		logger.debug(getAstro(birth));
		...
		System.out.println(DateUtil.subMonth("2014-01-18", new Date()));
     ...
     * 
     * @param srcDate date need to compare
     * @param comparedDate date which is compared
     * @return true/false
     */
